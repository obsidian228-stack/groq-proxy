  ...
  try {
    const requestBody = (req.body && Object.keys(req.body).length > 0) 
      ...
      : {
          ...
          messages: [{ role: "user", content: "Напиши ОДИН не вымышленный, случайный, безумно интересный или парадоксальный и очень необычный факт на русском языке. Темы любые: рекорды, люди, животные. Строго ОДНО или ДВА коротких преложений, не длиннее 30 слов! Пиши сразу сам факт без приветствий и вводных слов." }]
        };
